        ...
        <div class="flex grow flex-col overflow-y-auto border-r border-neutral-200 bg-white">
          ...
          <div class="px-4 py-3">
            <Dropdown>
              ...
              <template #content>
                <ul>
                  <li><button @click.prevent="repoPickerModal.openModal();" class="link w-full">Change repository</button></li>
                  ...
                  <li>
                    <router-link v-for="branch in branches" :to="{ name: route.name, params: {...route.params, branch: branch }}" class="link w-full">
                      {{ branch }}
            ...
            <ul role="list" class="flex flex-1 flex-col">
              <li>
                <ul role="list" class="space-y-1">
                  <li>
                    <div>
                      <div class="font-medium text-neutral-950 flex items-center gap-x-2 rounded-xl py-2 px-3 transition-colors">
                        ...
                        <!-- <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 shrink-0" viewBox="0 -960 960 960">
                      ...
                      <ul class="mt-1 pl-8 space-y-1">
                        <li v-for="item in config.content" :key="item.name">
                          <router-link :to="{ name: 'content', params: { name: item.name } }" class="link !text-sm">
                            {{ item.label }}
                          </router-link>
                        </li>
                      </ul>
                  ...
                  <li>
                    <router-link :to="{ name: 'media' }" class="link">
