    ...
    <div class="fb">
      <header class="fb-header flex mb-4 gap-x-2">
        ...
        <div class="fb-view flex">
          <button @click="setLayout('list')" class="fb-view-list group btn-icon-sm !rounded-r-none" :disabled="layout == 'list'" :class="{ '!bg-neutral-200': (layout == 'list') }">
          ...
          <button @click="setLayout('grid')" class="fb-view-grid group btn-icon-sm !rounded-l-none !border-l-0" :disabled="layout == 'grid'" :class="{ '!bg-neutral-200': (layout == 'grid') }">
            <svg class="h-4 v-4 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">
