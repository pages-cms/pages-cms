					...
					:	isGithubUser
							? <Empty className="absolute inset-0 border-0 rounded-none">
									<EmptyHeader>
										...
										<EmptyDescription>
											Pages CMS needs to be installed on at least one GitHub account before you can open or create projects.
										</EmptyDescription>
									</EmptyHeader>
									<EmptyContent>
						  ...
						  : <Empty className="absolute inset-0 border-0 rounded-none">
									<EmptyHeader>
										...
										<EmptyDescription>
											You must be invited to a repository to collaborate. Ask the person who invited you or manages your organization to invite you.
										</EmptyDescription>
									</EmptyHeader>
								</Empty>
				}
