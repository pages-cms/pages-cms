...
CREATE INDEX `idx_cache_owner_repo_branch_parentPath` ON `cache` (`owner`,`repo`,`branch`,`parent_path`);--> statement-breakpoint
CREATE UNIQUE INDEX `idx_cache_owner_repo_branch_path` ON `cache` (`owner`,`repo`,`branch`,`path`);--> statement-breakpoint
...
CREATE INDEX `idx_history_userId_lastVisited` ON `history` (`user_id`,`last_visited`);--> statement-breakpoint
