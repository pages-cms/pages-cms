...
const version =
  process.env.NEXT_PUBLIC_APP_VERSION ?? inferredTagVersion ?? packageJson.version;
  ...
  return (
    <DialogContent className="w-[20rem] max-w-[calc(100vw-2rem)]">
      <DialogHeader className="items-center gap-3 text-center">
        ...
        <DialogDescription>
          Open source CMS for static sites. Edit directly on GitHub with a clean
          interface.
        </DialogDescription>
      </DialogHeader>
      ...
      <div className="rounded-lg border">
        ...
        <Row
          label="Website"
          value={
            <ExternalLink href="https://pagescms.org">pagescms.org</ExternalLink>
          }
        />
        <Row
          label="Docs"
